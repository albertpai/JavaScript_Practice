...
// Using map in a clumsy way
// var rating = [];
// var myfunction;
// myfunction = watchList.map((value, index) => {
//     rating[index] = 
//         {
//             "title": watchList[index]["Title"],
//             "rating": watchList[index]["imdbRating"]
//         }
//     return rating;
// });
// console.log(rating);
...
//Using map in a better way
var rating = watchList.map((v, i)=> {
    return ({title: watchList[i].Title, rating: watchList[i].imdbRating}
    )})
console.log(rating);
